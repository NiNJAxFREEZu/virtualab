...
apt install python python3-pip git libnotify-bin --quiet --yes || echoerr "Error while trying to install a package - apt package manager is currently being used by another process."
