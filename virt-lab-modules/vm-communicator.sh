...
git clone https://github.com/wranidlo/broadcast_sender_receiver /etc/virtualab/vm-communicator --quiet || echoerr "Error while trying to pull git repository for vm-communicator."
